...
const ActivityInfo = ({ currentActivity }: ActivityInfoProps) => {
    ...
    return (
        <div className="text-white">
            <div className="md:flex p-4 flex-col lg:flex-row hidden">
            ...
            <div className="md:hidden flex text-xs mt-5">
                <div className="mx-auto">
                    <div className="flex text-white text-lg ml-9 lg:justify-normal">
                        {currentActivity?.name}
                    </div>
                    <p className="w-[70%] mx-auto lg:mx-0 text-gray-400">
                        {currentActivity?.description}
                    </p>
                    <p className="flex flex-col mt-2 ml-8 space-y-1">
                        <span className="text-gray-300 font-semibold flex items-center lg:justify-normal">
                            <MdCategory className="mr-2 w-6 h-6 bg-secondaryColor rounded-full text-gray-700 p-0.5" />
                            {t("Category")}:{" "}
                            <span className=" text-gray-400 ml-2 font-normal">
                                {currentActivity?.category}
