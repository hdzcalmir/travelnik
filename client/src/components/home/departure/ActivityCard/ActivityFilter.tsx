        ...
        <form className="flex items-center">
          ...
          <div className="relative w-full">
            ...
            <input
              ...
              className="bg-gray-50 border outline-none border-gray-300 text-gray-900 text-sm rounded-lg block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
              placeholder="Search"
            />
          </div>
        </form>
