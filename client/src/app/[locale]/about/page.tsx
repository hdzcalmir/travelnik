            ...
            <section className="text-white bg-gray-800 mt-12">
                <div className="mx-auto flex pb-4 md:flex-row flex-col items-center">
                    ...
                    <div className="md:w-1/2 flex flex-col md:items-start md:text-left text-center">
                        ...
                        <p className="mb-8 leading-relaxed text-gray-300">At Travelnik, we believe in the transformative power of travel to create meaningful connections, broaden perspectives, and cultivate a deep appreciation for diversity. By providing reliable information, personalized recommendations, and fostering a vibrant community of explorers, we aspire to make every visitor&apos;s journey to Travnik a delightful and enriching adventure.</p>
                        <div className="flex">
                            <div className="justify-end">
                                <Link href="/">
                                    <button className="bg-gray-600 transition duration-500 inline-flex py-3 px-5 rounded-lg items-center lg:mr-4 md:ml-0 mr-4 md:mt-4 mt-0 lg:mt-0 hover:bg-gray-500 focus:outline-none">
                                        <FaSearchLocation className="w-6 h-6" />
                                        <span className="ml-4 flex items-start flex-col leading-none">
                                            <span className="text-xs text-white mb-1">Start exploring on the</span>
                                            <span className="title-font font-medium">Website</span>
                                        </span>
                                    </button>
                                </Link>
                                <button className="bg-gray-600 transition duration-500 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-500 focus:outline-none">
                                ...
                                <button className="bg-gray-600 transition duration-500 inline-flex py-3 px-5 rounded-lg items-center lg:ml-4 md:ml-0 ml-4 md:mt-4 mt-0 lg:mt-0 hover:bg-gray-500 focus:outline-none">
            ...
            <section className="text-gray-600 body-font relative">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-12">
                        ...
                        <p className="lg:w-2/3 mx-auto leading-relaxed text-gray-400">Interested in collaborating with Travelnik? Reach out to discuss potential partnerships and collaborations.</p>
                    </div>
                        ...
                        <div className="flex flex-wrap -m-2">
                            <div className="p-2 w-1/2">
                                <div className="relative">
                                    ...
                                    <input type="text" id="name" name="name" placeholder="Enter your name" className="w-full bg-gray-700 bg-opacity-50 rounded border border-gray-700 focus:border-secondaryColor focus:ring-2 focus:ring-gray-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                </div>
                            </div>
                            <div className="p-2 w-1/2">
                                <div className="relative">
                                    <label htmlFor="email" className="leading-7 text-sm text-gray-400">Email</label>
                                    <input type="email" id="email" name="email" placeholder="Enter your email" className="w-full bg-gray-700 bg-opacity-50 rounded border border-gray-700 focus:border-secondaryColor focus:ring-2 focus:ring-gray-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                </div>
                            </div>
                            <div className="p-2 w-full">
                                <div className="relative">
                                    <label htmlFor="message" className="leading-7 text-sm text-gray-400">Message</label>
                                    <textarea id="message" name="message" placeholder="Enter your message" className="w-full bg-gray-700 bg-opacity-50 rounded border border-gray-700 focus:border-secondaryColor focus:ring-2 focus:ring-gray-500 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
                                </div>
                            </div>
                            <div className="p-2 w-full">
                                <button className="flex mx-auto text-white bg-secondaryColor/80 border-0 py-2 px-8 focus:outline-none hover:bg-secondaryColor transition duration-500 rounded text-lg">Send</button>
                            </div>
                            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                                <a className="text-secondaryColor">info@travelnik.ba</a>
                                <p className="leading-normal my-5 text-gray-400">Slana Dolina
                                    <br></br>Travnik, 72270
                                </p>
